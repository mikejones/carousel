...
(function($){
  $.fn.carousel = function(options) {
    ...
    return this.each(function() {
      this.unlockButtons = function() {self.lock=false;};
      ...
      this.onLastItem = function() { return options.index == (list.children().length - options.showItems)-1; };
      ...
      this.checkButtonClasses = function() {
      ...
      container.addClass("carousel").css("width", listItemWidth * options.showItems).css("overflow", "hidden");;
